...
// Imported from https://raw.githubusercontent.com/snapcore/snapd/master/strutil/quantity/quantity.go
// to avoid a dependency on github.com/snapcore/snapd/osutil which depends on the wrong
// context package.
...
// FormatBPS formats the given quantity in bit/s
...
// FormatDuration formats the given dt which is in seconds (as in the output of time.Now().Seconds())
